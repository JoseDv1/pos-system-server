...
import { createSaleService, deleteSaleService, findSaleByIdService, findSalesService, getSalesReportByDateService, markAllSalesAsPaidByClientService, markSaleAsPaidService, markSaleAsPendingService, updateSaleService } from "./salesService";
...
export async function getSalesReportByDate(ctx: Context) {
	const { from, to } = ctx.req.query();
